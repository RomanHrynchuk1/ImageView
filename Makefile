...
# Template: app
# Command: C:/Qt/Qt5.14.2/5.14.2/mingw73_32/bin/qmake.exe -o Makefile imageView.pro -spec win32-g++ CONFIG+=qtquickcompiler
#############################################################################
...
ZIP           = 
DEF_FILE      = 
RES_FILE      = imageView_resource_res.o
SED           = sed
MOVE          = mv -f
SUBTARGETS    =  \
		release \
...
Makefile: imageView.pro C:/Qt/Qt5.14.2/5.14.2/mingw73_32/mkspecs/win32-g++/qmake.conf C:/Qt/Qt5.14.2/5.14.2/mingw73_32/mkspecs/features/spec_pre.prf \
	...
	$(QMAKE) -o Makefile imageView.pro -spec win32-g++ CONFIG+=qtquickcompiler
